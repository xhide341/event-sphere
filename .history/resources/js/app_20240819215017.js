...
// Try importing from the specific path
import particlesJS from '../node_modules/particles.js/particles.js'; // Adjust the path as necessary

particlesJS.load('particles-js', './particles.json', (status) => {
    if (status) {
