                        ...
                        <div class="relative flex flex-col items-center justify-center space-y-10 text-primary tracking-widest">
                            ...
                            <div class="flex flex-row items-center justify-center space-x-20 text-primary text-center">
                                <div class="is-hidden avatar">
                                    <img src="{{ Vite::asset('resources/images/boy1.png') }}" alt="Placeholder Image" class="h-[200px] gap-y-10 transition-transform duration-300 ease-in-out hover:scale-110">
                                    <p class="text-2xl font-bold">Shawne Nuque</p>
                                    <p class="text-sm">Web Developer</p>
                                </div>
                                <div class="is-hidden avatar">
                                    <img src="{{ Vite::asset('resources/images/girl1.png') }}" alt="Placeholder Image" class="h-[200px] gap-y-10 transition-transform duration-300 ease-in-out hover:scale-110">
                                    <p class="text-2xl font-bold">Lorrea Delos Reyes</p>
                                    <p class="text-sm">Project Researcher</p>
                                </div>
                                <div class="is-hidden avatar">
                                    <img src="{{ Vite::asset('resources/images/girl2.png') }}" alt="Placeholder Image" class="h-[200px] gap-y-10 transition-transform duration-300 ease-in-out hover:scale-110">
