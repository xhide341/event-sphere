...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-poppins">
        <div class="text-black/50 text-primary bg-white-500">
            ...
            <section class="text-center py-10 -my-10 z-10 relative border-2 border-primary-200">
                <h2 class="text-xl font-semibold">Powered by</h2>
            </section>
            
            <!-- creator section -->
            <div class="relative bg-white-500">
                <section id="about">
                    <div class="min-h-[70dvh] w-full flex items-center py-16 justify-center border-y-2 border-gray-200">
