    ...
    <body class="antialiased font-poppins">
        <div class="relative text-primary bg-white">
            <div class="relative min-h-screen flex flex-col bg-landing border-b-2 border-gray-200">
                ...
                <!-- home -->
                <section class="#home">
                    <div class="w-full h-full flex items-center justify-center text-white flex flex-col items-center justify-between">
                        <div class="py-20">
                        ...
                        <!-- benefits section -->
                        <div class="flex items-center justify-between h-full py-16">
