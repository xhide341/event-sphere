...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-poppins">
        <div class="relative text-primary bg-white">
            <div class="relative min-h-screen flex flex-col items-center justify-start bg-landing border-b-2 border-gray-200 pb-20">
                <!-- header -->                 
            ...
            <!-- powered by section -->
            <section class="absolute min-w-[50dvw] w-[50dvw] flex space-x-6 items-center justify-center mx-auto text-center py-8 px-16 -mt-12 z-10 relative border-2 border-primary bg-white shadow-lg rounded-lg border-shadow">
            ...
            <div class="relative bg-white">
                <!-- how it all started -->
                 <section id="how-it-all-started">
                    <div class="relative min-h-[70dvh] flex flex-col items-center pt-16 text-primary tracking-widest">
