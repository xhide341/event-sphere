            ...
            <div class="relative bg-white">
                ...
                <section id="contact">
                    <div class="min-h-[60dvh] w-full flex flex-col items-center py-16 border-b-2 border-gray-200">
                        ...
                        <p class="text-lg mb-2">For inquiries, you can reach us at:</p>
                        <p class="text-lg mb-2">Email: <a href="mailto:team@example.com" class="text-accent">team@example.com</a></p>
