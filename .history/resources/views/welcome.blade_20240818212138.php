...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-poppins">
        <div class="relative text-primary bg-white">
            <div class="relative min-h-screen flex flex-col bg-landing border-b-2 border-gray-200">
                <!-- header -->                 
                ...
                <!-- how it all started -->
                 <section id="how-it-all-started">
                    <div class="relative min-h-[70dvh] flex flex-col items-center py-16 text-primary tracking-widest border-b-2 border-gray-200">
                        ...
                        <div class="flex space-x-6"> <!-- Flex container for perks -->
                            <div class="flex flex-col items-center">
                                <span class="text-2xl font-bold">✔️ Easy Event Management</span>
                                <p class="text-sm text-center">Streamline your event planning process with our intuitive tools.</p>
                            </div>
                            <div class="flex flex-col items-center">
                                <span class="text-2xl font-bold">✔️ Community Engagement</span>
                                <p class="text-sm text-center">Connect with attendees and foster a sense of community.</p>
                            </div>
                            <div class="flex flex-col items-center">
                                <span class="text-2xl font-bold">✔️ Real-time Updates</span>
                                <p class="text-sm text-center">Stay informed with instant notifications and updates.</p>
                            </div>
                        </div>
                    </div>
                 </section>
