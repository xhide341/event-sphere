...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-sans">
        <div class=" text-black/50 bg-blue-500 text-primary">
            <img src="C:\Users\shawn\Herd\event-sphere\resources\images\al-nik-conf-room-unsplash.jpg" alt="conference room">
