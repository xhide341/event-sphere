    ...
    <body class="antialiased font-poppins">
        <div class="text-black/50 text-primary min-h-screen bg-landing">
            <div class="relative min-h-screen flex flex-col">
                <div class="w-full max-w-7xl px-6 bg-white/10 backdrop-blur-md rounded-lg shadow-lg px-6 ">
                    <header class="mx-auto py-6 flex items-center justify-between w-full -mx-6">
