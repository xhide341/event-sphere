            ...
            <section id="about">
                <div class="min-h-[500px] flex items-center justify-center text-primary">
                    ...
                    <div class="flex items-center justify-center">
                        <img src="{{ Vite::asset('resources/images/boy1.png') }}" alt="Placeholder Image" class="is-hidden h-400 w-200 border-2 border-primary ">
                        <img src="{{ Vite::asset('resources/images/girl1.png') }}" alt="Placeholder Image" class="is-hidden h-400 w-200 border-2 border-primary ">
                        <img src="{{ Vite::asset('resources/images/girl2.png') }}" alt="Placeholder Image" class="is-hidden h-400 w-200 border-2 border-primary ">
                    </div>
                </div>
            </section>
