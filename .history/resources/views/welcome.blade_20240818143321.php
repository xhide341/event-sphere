...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-poppins">
        <div class="text-black/50 text-primary bg-white-500">
            ...
            <!-- creator section -->
            <div class="relative bg-white-900">
                <section id="about">
                    <div class="min-h-[70dvh] w-full flex items-center justify-center border-2 border-gray-200">
                ...
                <!-- contact section -->
                <section id="contact">
                    <div class="min-h-[50dvh] w-full flex items-center justify-center text-primary">
