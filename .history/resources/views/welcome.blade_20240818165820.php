                ...
                <section id="about">
                    <div class="min-h-[65dvh] w-full flex items-center pb-16 justify-center border-b-2 border-gray-200">
                        <div class="relative flex flex-col items-center justify-center space-y-10 text-primary tracking-widest">
                            ...
                            <p class="text-justify text-lg w-[40dvw] mx-auto tracking-normal">We are a team of 3 students from La Consolacion University Philippines, taking up Bachelor of Science in Information Technology. This system is part of our final capstone project.</p>
