                        ...
                        <div class="relative flex flex-col items-center justify-center space-y-10 text-primary tracking-widest">
                            ...
                            <div class="flex flex-row items-center justify-center space-x-20 text-primary text-center">
                                <div class="is-hidden avatar text-center flex flex-col items-center justify-center">
                                    <img src="{{ Vite::asset('resources/images/boy1.png') }}" alt="Placeholder Image" class="h-[200px] transition-transform duration-300 ease-in-out hover:scale-110 hover:border-2 hover:border-primary">
                                    <p class="text-2xl font-bold mt-2">Shawne Nuque</p>
                                    <p class="text-sm">Web Developer</p>
                                </div>
                                <div class="is-hidden avatar text-center flex flex-col items-center justify-center">
                                    <img src="{{ Vite::asset('resources/images/girl1.png') }}" alt="Placeholder Image" class="h-[200px] transition-transform duration-300 ease-in-out hover:scale-110 hover:border-2 hover:border-primary">
                                    <p class="text-2xl font-bold mt-2">Lorrea Delos Reyes</p>
                                    <p class="text-sm">Project Researcher</p>
                                </div>
                                <div class="is-hidden avatar text-center flex flex-col items-center justify-center">
                                    <img src="{{ Vite::asset('resources/images/girl2.png') }}" alt="Placeholder Image" class="h-[200px] transition-transform duration-300 ease-in-out hover:scale-110 hover:border-2 hover:border-primary">
