    ...
    <body class="antialiased font-poppins">
        <div class="text-black/50 text-primary bg-white-500">
            ...
            <div class="relative bg-white">
                <section id="about">
                    <div class="min-h-[600px] flex items-center justify-center border-2 border-gray-200">
                        <div class="relative flex flex-col items-center justify-center space-y-10 text-primary tracking-widest">
                            <h1 class="text-5xl font-bold relative">
                                <span class="bg-black text-white px-2">Meet the team</span>
                            </h1>
                            <img src="{{ Vite::asset('resources/images/curve-arrow.svg') }}" alt="Curve Arrow" class="absolute" style="top: 50%; transform: translateY(-50%); left: calc(50% - 20px);">
                ...
                <!-- contact section -->
                <section id="contact">
                    <div class="min-h-[700px] flex items-center justify-center text-primary">
