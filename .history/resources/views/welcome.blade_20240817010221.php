            ...
            <section id="about">
                <div class="min-h-[600px] flex items-center justify-center bg-primary">
                    <div class="relative flex flex-col items-center justify-center space-y-10 text-white">
                        ...
                        <img src="{{ Vite::asset('resources/images/curve-arrow.svg') }}" alt="Curve Arrow" class="absolute w-[100px]] h-[100px]" style="top: 50%; transform: translateY(-50%); left: calc(50% - 20px);">
