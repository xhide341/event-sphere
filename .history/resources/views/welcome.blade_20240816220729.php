                ...
                <section>
                    <div class="w-full h-full flex items-center justify-between text-white">
                        <div class="p-40 w-1/2">
                            <p class="text-sm px-1">Event Management System for LCUP</p>
                            <h1 class="text-5xl font-bold">Events made easy</h1>
                        </div>
                        <div class="w-1/2 border-2 border-gray-300 rounded-lg overflow-hidden"> <!-- Added border and rounded corners -->
