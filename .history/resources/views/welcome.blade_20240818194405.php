    ...
    <body class="antialiased font-poppins">
        <div class="relative text-primary bg-white">
            ...
            <div class="relative bg-white">
                <!-- how it all started -->
                 <section id="how-it-all-started">
                    <div class="relative min-h-[70dvh] flex flex-col items-center py-16 text-primary tracking-widest border-b-2 border-gray-200">
                        <h2 class="text-4xl font-bold mb-6">
                            <span class="bg-primary text-white px-2">How</span> it all started 🚀
                        </h2>
                        <p class="text-justify text-lg w-[40dvw] mx-auto tracking-normal leading-8 mb-12">
                ...
                <!-- contact section -->
                <section id="contact">
                    <div class="min-h-[60dvh] w-full flex flex-col items-center py-16 border-b-2 border-gray-200">
                        <h1 class="text-4xl font-bold relative mb-6">
                            <span class="bg-primary text-white px-2">Connect</span> with us
                        </h1>
                        <!-- Additional Contact Details -->
                        <div class="mb-4 text-center">
                            <p class="text-lg">For inquiries, you can reach us at:</p>
                            <p class="text-lg">Email: <a href="mailto:team@example.com" class="text-accent">team@example.com</a></p>
                            <p class="text-lg">Phone: <a href="tel:+1234567890" class="text-accent">+1 (234) 567-890</a></p>
                        </div>
                        <!-- Contact Form -->
                        <form class="w-full max-w-md">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="message" placeholder="Your Message" required></textarea>
                            </div>
                            <div class="flex items-center justify-between">
                                <button class="bg-primary hover:bg-accent text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
                                    Submit
                                </button>
                            </div>
                        </form>
            ...
            <footer class="py-6 flex items-center justify-between text-sm text-primary w-full max-w-7xl px-6 mx-auto">
                <div class="flex items-center">
                    <img src="{{ Vite::asset('resources/images/eventsphere_logo.png') }}" alt="Logo" class="w-10 h-10 rounded-full">
                    <p class="font-gloria text-lg ml-2">eventsphere</p>
                </div>
