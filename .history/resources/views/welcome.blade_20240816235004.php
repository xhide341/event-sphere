...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-poppins">
        <div class="text-black/50 text-primary bg-white-500">
            ...
            <!-- creator section -->
            <section id="about">
                <div class="min-h-[500px] flex items-center justify-center text-primary">
                    <h1 class="is-hidden text-5xl font-bold">About</h1>

                    <div class="flex items-center justify-center">
                        <img src="{{ Vite::asset('resources/images/boy1.png') }}" alt="Placeholder Image" class="is-hidden h-200 w-200 border-2 border-primary ">
                        <img src="{{ Vite::asset('resources/images/girl1.png') }}" alt="Placeholder Image" class="is-hidden h-200 w-200 border-2 border-primary ">
                        <img src="{{ Vite::asset('resources/images/girl2.png') }}" alt="Placeholder Image" class="is-hidden h-200 w-200 border-2 border-primary ">
                    </div>
                </div>
            </section>
