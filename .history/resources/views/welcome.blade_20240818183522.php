...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-poppins">
        <div class="relative text-black/50 text-primary bg-white-500">
            ...
            <!-- footer -->
            <footer class="py-8 text-center text-sm text-primary flex items-center justify-center">
                &copy; 2024 eventsphere. All rights reserved.
                <a href="YOUR_GITHUB_REPO_LINK" target="_blank" class="hover:animate-spin transition-transform duration-300">
