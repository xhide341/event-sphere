...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-poppins">
        <div class="text-black/50 text-primary bg-white-500">
            ...
            <section class="min-w-[50dvw] w-[50dvw] flex items-center justify-center mx-auto text-start py-16 px-20 -my-10 z-10 relative border-2 border-primary bg-primary rounded-lg">
