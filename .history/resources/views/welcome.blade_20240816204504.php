...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-poppins">
        <div class="text-black/50 bg-gray-200 text-primary min-h-screen bg-landing">
            <div class="relative min-h-screen flex flex-col">
                <div class="w-full max-w-7xl mx-auto px-6">                                     
                    <header class="py-6 flex items-center justify-between text-white">
                        ...
                        <nav class="flex space-x-16 text-inherit">
