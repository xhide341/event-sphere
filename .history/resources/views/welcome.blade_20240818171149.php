    ...
    <body class="antialiased font-poppins">
        <div class="relative text-black/50 text-primary bg-white-500">
            ...
            <div class="relative bg-white">
                <section id="about">
                    <div class="min-h-[80dvh] w-full flex items-center pb-16 justify-center border-b-2 border-gray-200">
                        <div class="relative flex flex-col items-center justify-center space-y-10 text-primary tracking-widest">
                            ...
                            <p class="text-justify text-lg w-[40dvw] mx-auto tracking-normal leading-8">We are a team of 3 students from <a href="https://www.facebook.com/LaConsolacionU" target="_blank" class="font-bold text-accent">La Consolacion University Philippines</a>, taking up Bachelor of Science in Information Technology. This system is part of our final capstone project.</p>
                ...
                <!-- contact section -->
                <section id="contact">
                    <div class="min-h-[50dvh] w-full flex items-center justify-center py-16 border-t-2 border-gray-200">
