            ...
            <div class="relative min-h-screen flex flex-col bg-landing">
                ...
                <section>
                    <div class="w-full h-full flex items-center justify-between">
                        <div class="text-center w-1/2 p-10 mx-auto text-white-500">
                            <h1 class="text-4xl font-bold">Welcome to Eventsphere!</h1> <!-- Big tagline -->
                            <p class="mt-2 text-lg">Your ultimate campus event management system.</p> <!-- Short subtext -->
                        </div>
                        <div class="w-1/2">
