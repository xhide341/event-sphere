    ...
    <body class="antialiased font-poppins">
        <div class="text-black/50 text-primary bg-white-500">
            ...
            <div class="relative bg-white">
                <section id="about">
                    <div class="min-h-screen w-full h-1/2 flex items-center justify-center border-2 border-gray-200">
                ...
                <!-- contact section -->
                <section id="contact">
                    <div class="min-h-1/2 flex items-center justify-center text-primary">
