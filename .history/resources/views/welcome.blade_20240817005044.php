    ...
    <body class="antialiased font-poppins">
        <div class="text-black/50 text-primary bg-white-500">
            <div class="relative min-h-screen flex flex-col bg-landing">
                <!-- header -->                 
                <div class="w-full flex justify-center bg-white/50 backdrop-blur-lg shadow-lg text-primary">
            ...
            <section id="about">
                <div class="min-h-[500px] flex items-center justify-center bg-primary">
                    <div class="flex flex-col items-center justify-center space-y-10 text-white">
                        <h1 class="is-hidden avatar text-5xl font-bold">Meet the team</h1>
                        <img src="{{ Vite::asset('resources/images/curve-arrow.svg') }}" alt="Curve Arrow" class="h-[300px] fill-white absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2">
