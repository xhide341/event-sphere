...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-poppins">
        <div class="text-black/50 text-primary bg-white-500">
            ...
            <!-- creator section -->
            <div class="bg-gradient-to-br from-primary to-white">
                <section id="about">
                    <div class="min-h-[600px] flex items-center justify-center bg-white border-2 border-gray-200">
                        <div class="relative flex flex-col items-center justify-center space-y-10 text-primary">
