...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="text-black/50 bg-white-500 text-primary bg-cover bg-center min-h-screen" style="background-image: url('{{ asset('images/al-nik-conf-room-unsplash.jpg') }}');"> 
