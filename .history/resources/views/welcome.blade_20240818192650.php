...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-poppins">
        <div class="relative text-primary bg-white-500">
            ...
            <div class="relative bg-white">
                <!-- how it all started -->
                 <section id="how-it-all-started">
                    <div class="relative min-h-[70dvh] flex flex-col items-center mt-16 text-primary tracking-widest border-b-2 border-gray-200">
                ...
                <section id="meet-the-team">
                    <div class="min-h-[70dvh] w-full flex items-center mt-16 pb-16 justify-center border-b-2 border-gray-200">
                ...
                <!-- contact section -->
                <section id="contact">
                    <div class="min-h-[60dvh] w-full flex items-center justify-center py-16 border-b-2 border-gray-200">
            ...
            <!-- footer -->
            <footer class="py-8 flex items-center justify-between text-sm text-primary w-full max-w-7xl px-6"">
                <div class="flex items-center">
                    <img src="{{ Vite::asset('resources/images/eventsphere_logo.png') }}" alt="Logo" class="w-10 h-10 rounded-full">
