            ...
            <section id="about">
                <div class="min-h-[500px] flex items-center justify-center bg-primary">
                    <div class="flex items-center justify-center space-x-10 text-white text-center">
                        <div class="is-hidden">
                            <img src="{{ Vite::asset('resources/images/boy1.png') }}" alt="Placeholder Image" class="h-[200px] avatar">
                            <p class="text-2xl font-bold">Shawne Nuque</p>
                            <p class="text-sm">Web Developer</p>
                        </div>
                        <div class="is-hidden">
                            <img src="{{ Vite::asset('resources/images/girl1.png') }}" alt="Placeholder Image" class="h-[200px] avatar">
                            <p class="text-2xl font-bold">Lorrea Delos Reyes</p>
                            <p class="text-sm">Project Researcher</p>
                        </div>
                        <div class="is-hidden">
                            <img src="{{ Vite::asset('resources/images/girl2.png') }}" alt="Placeholder Image" class="h-[200px] avatar">
