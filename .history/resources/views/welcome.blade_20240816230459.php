    ...
    <body class="antialiased font-poppins">
        <div class="text-black/50 text-primary bg-white-500">
            <div class="relative min-h-screen flex flex-col bg-landing">
                <!-- header -->
                <div class="w-full flex justify-center bg-white/30 backdrop-blur shadow-sm">
            ...
            <section class="#about">
                <div class="min-h-[500px] flex items-center justify-center text-primary">
                    <h1 class="hidden text-5xl font-bold">About</h1>
                </div>
            </section>

            <!-- contact section -->
            <section class="#contact">
                <div class="min-h-screen flex items-center justify-center text-primary">
                    <h1 class="hidden text-5xl font-bold">Contact</h1>
                </div>
            </section>
