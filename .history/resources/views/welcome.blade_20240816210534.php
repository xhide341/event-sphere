                    ...
                    <div class="w-full max-w-7xl px-6">
                        <header class="py-6 flex items-center justify-between w-full px-6 -mx-6">
                            ...
                            <nav class="flex space-x-16 text-primary">
                                <a href="" class="hover:text-accent relative group transition-transform duration-300 ease-in-out hover:-rotate-2">
                                    <span class="relative z-10">Home</span>
                                    <span class="absolute left-0 bottom-0 w-full h-0.5 bg-primary scale-x-0 transition-transform duration-300 ease-in-out origin-left"></span>
                                </a>
                                <a href="" class="hover:text-accent relative group transition-transform duration-300 ease-in-out hover:-rotate-2">
