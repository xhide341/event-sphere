    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
            <a wire:navigate href="/events" 
                class="flex items-center px-4 py-2 mt-5 {{ request()->routeIs('events') ? 'text-gray-200 bg-gray-800 active:bg-gray-800 focus:bg-gray-800' : 'text-primary' }} duration-300 transform rounded-lg hover:bg-gray-800 hover:text-gray-200 active:text-white">
                <svg class="w-5 h-5 duration-300 hover:stroke-gray-200" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a wire:navigate href="/profile" 
                class="flex items-center px-4 py-2 mt-5 {{ request()->routeIs('profile') ? 'text-gray-200 bg-gray-800 active:bg-gray-800 focus:bg-gray-800' : 'text-primary' }} duration-300 transform rounded-lg hover:bg-gray-800 hover:text-gray-200">
                <svg class="w-5 h-5 duration-300 hover:stroke-gray-200" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a wire:navigate href="/venues" 
                class="flex items-center px-4 py-2 mt-5 {{ request()->routeIs('venues') ? 'text-gray-200 bg-gray-800 active:bg-gray-800 focus:bg-gray-800' : 'text-primary' }} duration-300 transform rounded-lg hover:bg-gray-800 hover:text-gray-200 active:text-white">
                <svg class="w-5 h-5 duration-300 hover:stroke-gray-200" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a wire:navigate href="/speakers" 
                class="flex items-center px-4 py-2 mt-5 {{ request()->routeIs('speakers') ? 'text-gray-200 bg-gray-800 active:bg-gray-800 focus:bg-gray-800' : 'text-primary' }} duration-300 transform rounded-lg hover:bg-gray-800 hover:text-gray-200 active:text-white">
                <svg class="w-5 h-5 duration-300 hover:stroke-gray-200" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a wire:navigate href="#" 
                class="flex items-center px-4 py-2 mt-5 text-primary duration-300 transform rounded-lg hover:bg-gray-800 hover:text-gray-200 active:text-white">
                <svg class="w-5 h-5 duration-300 hover:stroke-gray-200" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
